...
class TrackAPITestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.bugle_call_rag = Track.objects.create(name='Bugle Call Rag',
                                                   slug='bugle-call-rag',
                                                   album=self.no_funny_hats)
        self.drum_solo = Solo.objects.create(instrument='drums',
                                             artist='Buddy Rich',
                                             slug='buddy-rich',
                                             track=self.bugle_call_rag)

    def test_retrieve_track(self):
        """Test that we can retrieve track"""
